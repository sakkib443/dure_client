                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-2xl font-semibold text-white">Chutli</span>
                        </div>
            ...
            <div className="bg-[#111111] py-8">
                <div className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-16 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-sm text-gray-500">
                        Copyright © {new Date().getFullYear()} <span className="text-white font-bold">Chutli</span>. All Rights Reserved.
                    </p>
