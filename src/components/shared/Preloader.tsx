...
const Preloader: React.FC = () => {
    ...
    return (
        <div
            ...
            style={{
                background: 'linear-gradient(135deg, #E3DEDB 0%, #d8d3cf 100%)',
                pointerEvents: fadeOut ? 'none' : 'auto',
            }}
        >
            {/* Background Elements */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full bg-[#800000]/15 blur-[100px]" style={{ animation: 'preloaderFloat 6s ease-in-out infinite' }} />
                <div className="absolute -bottom-32 -right-32 w-[400px] h-[400px] rounded-full bg-[#800000]/10 blur-[80px]" style={{ animation: 'preloaderFloat 8s ease-in-out infinite reverse' }} />
                ...
                <div className="relative mb-8">
                    ...
                    <div className="w-32 h-32 rounded-full" style={{ animation: 'preloaderSpin 3s linear infinite' }}>
                        <svg viewBox="0 0 128 128" className="w-full h-full">
                            <circle cx="64" cy="64" r="60" fill="none" stroke="rgba(0,0,0,0.05)" strokeWidth="2" />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-24 h-24 rounded-full flex items-center justify-center" style={{
                            ...
                            <svg width="56" height="56" viewBox="0 0 56 56">
                                <circle cx="28" cy="28" r="24" fill="rgba(128,0,0,0.12)" stroke="rgba(0,0,0,0.15)" strokeWidth="1"/>
                                <ellipse cx="28" cy="28" rx="13" ry="24" fill="none" stroke="rgba(0,0,0,0.1)" strokeWidth="0.8"/>
                                <ellipse cx="28" cy="28" rx="20" ry="24" fill="none" stroke="rgba(0,0,0,0.05)" strokeWidth="0.6"/>
                    ...
                    <div className="absolute inset-[-6px]" style={{ animation: 'preloaderSpin 2s linear infinite reverse' }}>
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full bg-[#800000] shadow-[0_0_12px_rgba(128,0,0,0.6)]" />
                    </div>
                </div>
                    ...
                    <div className="h-[2px] bg-white/[0.06] rounded-full overflow-hidden">
                        <div
                            ...
                            style={{
                                ...
                                background: 'linear-gradient(90deg, #800000, #a83a3a, #800000)',
                                boxShadow: '0 0 8px rgba(128,0,0,0.4)',
                            }}
                        />
                    </div>
                    <div className="flex justify-between mt-2">
                        <span className="text-[10px] text-black/40 font-medium tracking-[0.2em] uppercase">Loading</span>
                        <span className="text-[10px] text-[#800000]/70 font-bold tabular-nums">
