        ...
        <div className="space-y-6 max-w-5xl">
            ...
            <div className="space-y-6">
                ...
                <SettingSection icon={FiGlobe} title="SEO & Marketing" description="Search engine and tracking settings">
                    <InputField label="Meta Title" value={seo.title || ''} onChange={(e: any) => updateSeo('title', e.target.value)} placeholder="Chutli - Premium E-Commerce" helper="Recommended: 50-60 characters" />
