        ...
        <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Inter', sans-serif" }}>
                ...
                <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: '380px' }}>
                    ...
                    <Link href="/" style={{ textDecoration: 'none' }}>
                        <div style={{ marginBottom: '10px' }}>
                            <span style={{ fontSize: '36px', fontWeight: 900, color: '#fff', letterSpacing: '-1px' }}>CHUTLI</span>
                        </div>
                        <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.5)', letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '48px' }}>
                            REALLY BRAND EVERYTHING
                        </div>
                    </Link>
                    ...
                    <h2 style={{ fontSize: '26px', fontWeight: 800, color: '#fff', marginBottom: '16px', lineHeight: 1.3 }}>
                        Exquisite Handloom &<br />Designer Collections
                    </h2>
                    <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.6)', lineHeight: 1.8, marginBottom: '48px' }}>
                        Premium traditional wear and contemporary styles,<br />curated for your elegant lifestyle.
                    </p>

                    {/* Features */}
                    {[
                        { icon: '💎', text: 'Premium Quality Fabrics' },
                        { icon: '🎨', text: 'Exclusive Designer Wear' },
                        { icon: '✨', text: 'Craftsmanship at its Best' },
                    ].map((f, i) => (
            ...
            <div style={{
                ...
                <div className="auth-mobile-logo" style={{ display: 'none', marginBottom: '32px', textAlign: 'center' }}>
                    <Link href="/" style={{ textDecoration: 'none' }}>
                        <span style={{ fontSize: '28px', fontWeight: 900, color: 'var(--color-primary)', letterSpacing: '-1px' }}>CHUTLI</span>
                    </Link>
                </div>
